...
**OpenTofu is the brain.** Manual configuration is technical debt. Every container, network bridge, and proxy device is defined in [OpenTofu](https://opentofu.org/) (Terraform). The entire internal cloud is managed via declarative HCL files pushed through the Incus API. The code *is* the documentation.
